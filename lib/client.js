...
function StompClient(opts) {
  ...
  var address, port, user, pass, protocolVersion, vhost, reconnectOpts, tlsOpts, heartBeat;
...
StompClient.prototype.onConnect = function() {
  ...
  frameEmitter.on('CONNECTED', function(frame) {
    if (frame && frame.headers && frame.headers.version === "1.1") {
